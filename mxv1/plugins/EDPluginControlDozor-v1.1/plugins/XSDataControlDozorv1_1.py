...
class XSDataControlImageDozor(object):
    def __init__(self, score=None, powder_wilson_rfactor=None, powder_wilson_correlation=None, powder_wilson_resolution=None, powder_wilson_bfactor=None, powder_wilson_scale=None, spots_resolution=None, spots_int_aver=None, spots_num_of=None, number=None, image=None, spotFile=None):
        if image is None:
            self._image = None
