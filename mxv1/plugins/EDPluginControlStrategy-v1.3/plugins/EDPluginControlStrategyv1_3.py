...
class EDPluginControlStrategyv1_3(EDPluginControl):
    ...
    def process(self, _edObject=None):
        ...
        self.DEBUG("EDPluginControlStrategyv1_3.process...")
    ...
    def postProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginControlStrategyv1_3.postProcess...")
    ...
    def finallyProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginControlStrategyv1_3.finallyProcess")
    ...
    def doRaddoseToBestTransition(self, _edPlugin):
        self.DEBUG("EDPluginControlStrategyv1_3.doRaddoseToBestTransition")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginControlStrategyv1_3.doRaddoseToBestTransition")
        ...
        from EDHandlerXSDataBestv1_3    import EDHandlerXSDataBestv1_3
        self._edHandlerXSDataBest = EDHandlerXSDataBestv1_3()
    ...
    def doFailureActionRaddose(self, _edPlugin=None):
        ...
        """
        self.DEBUG("EDPluginControlStrategyv1_3.doFailureActionRaddose")
        self.retrieveFailureMessages(_edPlugin, "EDPluginControlStrategyv1_3.doFailureActionRaddose")
        strWarningMessage = "EDPluginControlStrategyv1_3: Raddose failure"
        self.warning(strWarningMessage)
        self.addWarningMessage(strWarningMessage)
    ...
    def doSuccessActionBest(self, _edPlugin=None):
        ...
        retrieve the potential warning messages
        """
        self.DEBUG("EDPluginControlStrategyv1_3.doSuccessActionBest")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginControlStrategyv1_3.doSuccessActionBest")
    ...
    def doFailureActionBest(self, _edPlugin):
        ...
        retrieve the potential error messages
        """
        self.DEBUG("EDPluginControlStrategyv1_3.doFailureActionBest")
    ...
    def generateExecutiveSummary(self, _edPlugin):
        ...
        """
        self.DEBUG("EDPluginControlStrategyv1_3.generateExecutiveSummary")
